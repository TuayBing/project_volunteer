...
function DeletePlanModal({ isOpen, onClose, onConfirm, planName, isLoading }) {
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
        <div className="flex justify-between items-start mb-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-lg font-semibold text-gray-900">ยืนยันการลบแผนกิจกรรม</h3>
          </div>
          <button
            onClick={onClose}
            disabled={isLoading}
        ...
        <div className="mb-6">
          <p className="text-gray-600">
            คุณต้องการลบแผนกิจกรรม{' '}
            <span className="font-medium text-gray-900">{planName}</span>{' '}
            ใช่หรือไม่? การลบแผนกิจกรรมจะส่งผลต่อกิจกรรมทั้งหมดในแผนนี้ และไม่สามารถย้อนกลับได้
          </p>
        </div>
