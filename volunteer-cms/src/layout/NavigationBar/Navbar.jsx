...
const Navbar = () => {
  ...
  const ProfileDropdown = () => (
    <div
      ref={dropdownRef}
      className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg z-50 py-2 before:content-[''] before:absolute before:-top-2 before:right-4 before:w-4 before:h-4 before:rotate-45 before:bg-white before:border-l before:border-t before:border-gray-100"
    >
      {isAdmin && (
        <Link
          to="/admin/dashboard"
