              ...
              <div className="md:hidden">
                <div className="px-2 pt-2 pb-3 space-y-1">
                  <div className="px-3 py-2 flex items-center space-x-2">
                    <NotificationDropdown ref={notificationRef} />
                    {/* Folder button for mobile/tablet */}
                    <button 
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white shadow-lg rounded-lg">
            ...
            {user ? (
              ...
              <div className="px-3 py-2">
                <Link
                  to="/login"
                  className="flex items-center justify-center px-4 py-2 bg-[#3BB77E] text-white rounded-full hover:bg-[#33a96e] transition-colors shadow-sm w-full"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
