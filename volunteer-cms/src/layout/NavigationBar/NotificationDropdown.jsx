  ...
  return (
    ...
    >
      ...
      >
        <Bell 
          size={24} 
          className="text-gray-600 hover:text-[#3BB77E] transition-colors duration-200" 
        />
        {unreadCount > 0 && (
      ...
      {isVisible && (
        <>
          {/* Desktop Dropdown */}
          <div className="hidden md:block absolute right-0 mt-2 w-96 z-50">
            <div className="before:content-[''] before:absolute before:-top-2 before:right-4 before:w-4 before:h-4 before:rotate-45 before:bg-white before:border-l before:border-t before:border-gray-100">
              <NotificationContent />
            </div>
          </div>
